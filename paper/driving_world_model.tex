...
\graphicspath{{../runs/}}   % all image paths relative to runs/
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{milestones.png}
\caption{
...
\begin{figure}[t]
\centering
\includegraphics[width=0.85\linewidth]{direct_bc/by_scene.png}
\caption{
...
\begin{subfigure}[b]{0.52\linewidth}
  \includegraphics[width=\linewidth]{dagger/progress.png}
  \caption{
...
\begin{subfigure}[b]{0.45\linewidth}
  \includegraphics[width=\linewidth]{direct_bc/by_scene.png}
  \caption{
